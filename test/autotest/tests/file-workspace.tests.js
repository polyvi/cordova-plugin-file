...
describe('File workspace', function() {
    ...
    describe('LocalFileSystem', function() {
        describe('window.requestFileSystem', function() {
            it("file.workspace.spec.1 PERSISTENT file system should contain workspace key word", function() {
            ...
            it("file.workspace.spec.2 TEMPORARY file system should contain workspace key word", function() {
                var win = jasmine.createSpy().andCallFake(function(fileSystem) {
                    expect(fileSystem).toBeDefined();
                    expect(fileSystem.root).toBeDefined();
                    expect(-1 != fileSystem.root.fullPath.indexOf('apps')).toBe(true);
        ...
        describe('window.resolveLocalFileSystemURI', function() {
            it("file.workspace.spec.3 should resolve app workspace correctly", function() {
            ...
            it("file.workspace.spec.4 should error (SECURITY_ERR) when resolving workspace parent", function() {
    ...
    describe('DirectoryEntry', function() {
        it("file.workspace.spec.5 getFile: should error (INVALID_MODIFICATION_ERR) when fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.6 getFile: should error (INVALID_MODIFICATION_ERR) when fileName points to workspace parent dir", function() {
            var fileName = "../de.file",
                fail = jasmine.createSpy().andCallFake(function(error) {
                    expect(error).toBeDefined();
                    expect(error).toBeFileError(FileError.INVALID_MODIFICATION_ERR);
        ...
        it("file.workspace.spec.7 DirectoryEntry.getDirectory: should error (INVALID_MODIFICATION_ERR) when fullPath points to workspace parent dir", function() {
            var dirName = "de.dir",
                fail = jasmine.createSpy().andCallFake(function(error) {
                    expect(error).toBeDefined();
                    expect(error).toBeFileError(FileError.INVALID_MODIFICATION_ERR);
        ...
        it("file.workspace.spec.8 DirectoryEntry.getDirectory: should error (INVALID_MODIFICATION_ERR) when fileName points to workspace parent dir", function() {
            var dirName = "../../de.dir",
                fail = jasmine.createSpy().andCallFake(function(error) {
                    expect(error).toBeDefined();
                    expect(error).toBeFileError(FileError.INVALID_MODIFICATION_ERR);
        ...
        it("file.workspace.spec.9 DirectoryEntry.removeRecursively on workspace parent: should error (INVALID_MODIFICATION_ERR) when fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.10 DirectoryEntry.removeRecursively on workspace: should error (NO_MODIFICATION_ALLOWED_ERR) when fullPath points to workspace dir", function() {
        ...
        it("file.workspace.spec.11 DirectoryEntry.removeRecursively on root file system", function() {
    ...
    describe('DirectoryReader', function() {
        describe("readEntries", function() {
            it("file.workspace.spec.12 should error (INVALID_MODIFICATION_ERR) when fullPath points to workspace parent dir", function() {
                var reader,
                    fail = jasmine.createSpy().andCallFake(function(error) {
                        expect(error).toBeDefined();
                        expect(error).toBeFileError(FileError.INVALID_MODIFICATION_ERR);
    ...
    describe('FileEntry', function() {
        it("file.workspace.spec.13 file: should error (INVALID_MODIFICATION_ERR) when fullPath points to workspace parent dir", function() {
    ...
    describe('Entry', function() {
        it("file.workspace.spec.14 Entry.getMetadata on file: should error (INVALID_MODIFICATION_ERR) when fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.15 Entry.getMetadata on directory: should error (INVALID_MODIFICATION_ERR) when fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.16 Entry.setMetadata on file: should error (INVALID_MODIFICATION_ERR) when fullPath points to workspace parent dir", function() {
            var entry = new Entry(true, false, 'entry.metadata.file', root.fullPath.replace('workspace', '')),
				fail = jasmine.createSpy().andCallFake(function(error) {
        ...
        it("file.workspace.spec.17 Entry.setMetadata on directory: should error (INVALID_MODIFICATION_ERR) when fullPath points to workspace parent dir", function() {
            var entry = new Entry(false, true, 'entry.metadata.dir', root.fullPath.replace('workspace', '')),
				fail = jasmine.createSpy().andCallFake(function(error) {
					expect(error).toBeUndefined();
				}),
        ...
        it("file.workspace.spec.18 Entry.getParent on file in root file system", function() {
        ...
        it("file.workspace.spec.19 Entry.getParent on file: should error (INVALID_MODIFICATION_ERR) when fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.20 Entry.getParent on directory in root file system", function() {
        ...
        it("file.workspace.spec.21 Entry.getParent on directory: should error (INVALID_MODIFICATION_ERR) when fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.22 Entry.getParent on workspace", function() {
        ...
        it("file.workspace.spec.23 Entry.getParent on root file system", function() {
        ...
        it("file.workspace.spec.24 Entry.remove on workspace parent: should error (INVALID_MODIFICATION_ERR) when fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.25 Entry.remove on workspace: should error (NO_MODIFICATION_ALLOWED_ERR) when fullPath points to workspace dir", function() {
            var entry = new Entry(false, true, 'entry.workspace.dir', root.fullPath),
				fail = jasmine.createSpy().andCallFake(function(error) {
					expect(error).toBeDefined();
					expect(error).toBeFileError(FileError.NO_MODIFICATION_ALLOWED_ERR);
        ...
        it("file.workspace.spec.26 Entry.remove on root file system", function() {
            var itRemove = jasmine.createSpy().andCallFake(function(error) {
                expect(error).toBeDefined();
                expect(error).toBeFileError(FileError.NO_MODIFICATION_ALLOWED_ERR);
            }),
        ...
        it("file.workspace.spec.27 copyTo file: should error (INVALID_MODIFICATION_ERR) when src file fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.28 copyTo directory: should error (INVALID_MODIFICATION_ERR) when src directory fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.29 copyTo file: should error (INVALID_MODIFICATION_ERR) when src dest file fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.30 copyTo directory: should error (INVALID_MODIFICATION_ERR) when dest directory fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.31 moveTo file: should error (INVALID_MODIFICATION_ERR) when src file fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.32 moveTo directory: should error (INVALID_MODIFICATION_ERR) when src directory fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.33 moveTo file: should error (INVALID_MODIFICATION_ERR) when src dest file fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.34 moveTo directory: should error (INVALID_MODIFICATION_ERR) when dest directory fullPath points to workspace parent dir", function() {
    ...
    describe('read method', function(){
        it("file.workspace.spec.35 readAsText: should error (INVALID_MODIFICATION_ERR) when file fullPath points to workspace parent dir", function() {
        ...
        it("file.workspace.spec.36 readAsDataURL: should error (INVALID_MODIFICATION_ERR) when file fullPath points to workspace parent dir", function() {
            var reader = new FileReader();
            var verifier = jasmine.createSpy().andCallFake(function(evt) {
                expect(evt).toBeDefined();
                expect(evt.target.error).toBeFileError(FileError.INVALID_MODIFICATION_ERR);
        ...
        it("file.workspace.spec.37 readAsBinaryString: should error (INVALID_MODIFICATION_ERR) when file fullPath points to workspace parent dir", function() {
            var reader = new FileReader();
            var verifier = jasmine.createSpy().andCallFake(function(evt) {
                expect(evt).toBeDefined();
                expect(evt.target.error).toBeFileError(FileError.INVALID_MODIFICATION_ERR);
        ...
        it("file.workspace.spec.38 readAsArrayBuffer: should error (INVALID_MODIFICATION_ERR) when file fullPath points to workspace parent dir", function() {
            var reader = new FileReader();
            var verifier = jasmine.createSpy().andCallFake(function(evt) {
                expect(evt).toBeDefined();
                expect(evt.target.error).toBeFileError(FileError.INVALID_MODIFICATION_ERR);
    ...
    describe('FileWriter', function(){
        it("file.workspace.spec.39 write: should error (INVALID_MODIFICATION_ERR) when file fullPath points to workspace parent dir", function() {
            var myFile = new File();
            myFile.fullPath = root.fullPath.replace('workspace', '');
        ...
        it("file.workspace.spec.40 truncate: should error (INVALID_MODIFICATION_ERR) when file fullPath points to workspace parent dir", function() {
            var myFile = new File();
            myFile.fullPath = root.fullPath.replace('workspace', '');
            var writer = new FileWriter(myFile),
                rule = "This is our sentence.";
